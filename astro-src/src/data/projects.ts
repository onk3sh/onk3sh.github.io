    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Self-review runs the thirteen checks that the sixteen recurring failure categories cluster into, across four parallel agents. Findings are classified AUTO, BATCH, or MANUAL, and written to Obsidian before completion is allowed.',
