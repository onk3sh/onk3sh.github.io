...
export const about: AboutContent = {
  ...
  paragraphs: [
    ...
    'The background: Adobe SDET on Acrobat (200M users, early beta team for XD) → Centric Consulting (owned test architecture for US BFSI enterprise, cut CI from 5 hours to 45 minutes) → Basis Technologies (senior backend IC, performance lead on ad-tech platform). The arc across all three: from writing tests that verified quality, to building the infrastructure that guaranteed it, to engineering the review process that makes autonomous agents produce it.',
  ],
};
