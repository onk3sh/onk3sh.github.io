...
export const about: AboutContent = {
  ...
  paragraphs: [
    ...
    'One thread runs through the rest of my career: desktop software at consumer scale, test architecture for a US banking and financial services enterprise that cut CI from 5 hours to 45 minutes, and performance work on a production ad-tech platform.',
